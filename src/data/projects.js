export const projects = [
  {
    ...
    problem:
      'Clinics often lose potential patients online — cluttered layouts, slow pages and no clear path to book an appointment.',
    solution:
  ...
  },
  {
    ...
    problem:
      'Fitness brands need an online presence with the same energy as their gym — intense, motivating and impossible to ignore.',
    solution:
      'Built a dark, high-contrast interface with dramatic motion, program showcases and a conversion-focused landing flow.',
    result:
      'A high-energy concept that captures brand intensity and guides visitors toward joining the community.',
